...
%The time complexity of $\mathit{eval}$ on a query is linear in the number of
%satisfying tuples for all the subqueries.
%We remark that this time complexity is nontrivial to achieve for conjunctions.
