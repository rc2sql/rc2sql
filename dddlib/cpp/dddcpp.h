...
# define False                 ddd_false()
  ...
  // Negation
  friend ddd operator!(const boolean& u);
  // Implication
  friend ddd operator>>(const boolean& u, const boolean& v);
  // Biimplication
  friend ddd operator==(const boolean& u, const boolean& v);
  ...
  friend ddd operator<(const difference& c, tCstr v);
  friend ddd operator<=(const difference& c, tCstr v);
  friend ddd operator==(const difference& c, tCstr v);
  friend ddd operator!=(const difference& c, tCstr v);
  friend ddd operator>(const difference& c, tCstr v);
  ...
  friend ddd operator<(tCstr v, const difference& c);
  friend ddd operator<=(tCstr v, const difference& c);
  friend ddd operator==(tCstr v, const difference& c);
  friend ddd operator!=(tCstr v, const difference& c);
  friend ddd operator>(tCstr v, const difference& c);
  ...
  friend ddd operator<(const real& x, const real& y);
  friend ddd operator<=(const real& x, const real& y);
  friend ddd operator==(const real& x, const real& y);
  friend ddd operator!=(const real& x, const real& y);
  friend ddd operator>=(const real& x, const real& y);
  ...
  // variables u[x:=b]
  friend ddd Assign(const ddd& u, const real& x, const real& y, tCstr c);
...
// Boolean operators; the priority is (the usual): !, >>, ==, &, |
// Negation
ddd operator!(const boolean& u);
// Implication
ddd operator>>(const boolean& u, const boolean& v);
// Biimplication
ddd operator==(const boolean& u, const boolean& v);
// not-Biimplication (xor)
ddd operator!=(const boolean& u, const boolean& v);
...
// Constructors for difference constraints such as x-y<c, etc.
ddd operator<(const difference& c, tCstr v);
ddd operator<=(const difference& c, tCstr v);
ddd operator==(const difference& c, tCstr v);
ddd operator!=(const difference& c, tCstr v);
ddd operator>(const difference& c, tCstr v);
...
// Constructors for difference constraints such as x<y and x<=y
ddd operator<(tCstr v, const difference& c);
ddd operator<=(tCstr v, const difference& c);
ddd operator==(tCstr v, const difference& c);
ddd operator!=(tCstr v, const difference& c);
ddd operator>(tCstr v, const difference& c);
...
ddd operator<(const real& x, const real& y);
ddd operator<=(const real& x, const real& y);
ddd operator==(const real& x, const real& y);
ddd operator!=(const real& x, const real& y);
ddd operator>=(const real& x, const real& y);
...
// Boolean operators on ddd's (the priority is the usual i C++: !, >>, ==, &, |)
ddd operator! (const ddd& u);               // Negation
ddd operator>>(const ddd& u, const ddd& v); // Implication
ddd operator==(const ddd& u, const ddd& v); // Biimplication
ddd operator!=(const ddd& u, const ddd& v); // not-Biimplication
ddd operator& (const ddd& u, const ddd& v); // Conjunction
ddd operator| (const ddd& u, const ddd& v); // Disjunction
ddd operator- (const ddd& u, const ddd& v); // Difference
...
ddd Forall(const varlist& v, const ddd& u);
ddd Exists(const varlist& v, const ddd& d);
